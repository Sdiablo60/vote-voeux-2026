...
# =========================================================
# 3. MUR SOCIAL (VERSION FINALE - CALC F11)
# =========================================================
else:
    ...
    # === CSS AVEC CALCUL DE HAUTEUR STRICT ===
    st.markdown("""
    <style>
        /* 1. Nettoyage */
        ...
        /* 3. LA FENÊTRE DU ROBOT (Calcul Mathématique) */
        /* La hauteur est forcée à : Ecran Total - Hauteur Titre */
        iframe[height="1000"] {
            position: fixed !important;
            top: 8vh !important;        /* Commence sous le titre */
            left: 0 !important;
            width: 100vw !important;
            height: calc(100vh - 8vh) !important; /* <--- LA CORRECTION F11 EST ICI */
            min-height: calc(100vh - 8vh) !important; /* Sécurité */
    ...
    # CSS INTERNE IFRAME (Cadre rouge)
