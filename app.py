...
# =========================================================
# 3. MUR SOCIAL (VERSION FINALE - VRAI NÉON ROUGE & POSITION HAUTE)
# =========================================================
else:
    ...
    # === CSS INTERNE IFRAME (Néon ROUGE & Position HAUTE) ===
    internal_css = f"""
    <style>
        ...
        {css_content}
        /* CONTENEUR CENTRAL ACCUEIL - REMONTÉ */
        #welcome-container {{
            position: absolute; 
            top: 42%; /* <-- REMONTÉ DE 52% A 42% */
        ...
        /* VRAI EFFET NÉON ROUGE THÈME */
        #welcome-title {{
            font-family: Arial, sans-serif;
            font-size: 70px; font-weight: 900; letter-spacing: 5px;
            margin: 0; padding: 0;
            color: #fff0f0; /* Blanc cassé rosé */
            text-shadow:
                0 0 5px #fff,
                0 0 10px #fff,
                0 0 20px #ff0000, /* Rouge vif */
                0 0 40px #E2001A, /* Rouge thème */
                0 0 80px #E2001A,
                0 0 90px #E2001A,
                0 0 100px #E2001A,
                0 0 150px #E2001A;
        ...
        @keyframes neon-flicker {{
            0%, 19%, 21%, 23%, 25%, 54%, 56%, 100% {{
                text-shadow:
                    0 0 5px #fff, 0 0 10px #fff, 0 0 20px #ff0000, 0 0 40px #E2001A,
                    0 0 80px #E2001A, 0 0 90px #E2001A, 0 0 100px #E2001A, 0 0 150px #E2001A;
            }}
            20%, 24%, 55% {{        
