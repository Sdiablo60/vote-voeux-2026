...
if est_admin:
    ...
    if not st.session_state["auth"]:
        ...
        with st.sidebar:
            ...
            st.divider()
            st.markdown("""<a href="/" target="_blank" style="display:block; text-align:center; background:#E2001A; color:white; padding:10px; border-radius:5px; text-decoration:none;">📺 MUR SOCIAL</a>""", unsafe_allow_html=True)
