...
# =========================================================
# 3. MUR SOCIAL (Version FINALE pour F11)
# =========================================================
else:
    ...
    # === CSS SPÉCIFIQUE ET PUISSANT POUR LE MUR SOCIAL ===
    st.markdown("""
    <style>
        /* 1. Fond NOIR et suppression des marges Streamlit */
        ...
        /* 2. LE BANDEAU TITRE (Fixé en haut) */
        .social-header { 
        ...
        /* 3. LA FENÊTRE DU ROBOT (Cible spécifique par hauteur) */
        /* C'est ICI la correction magique pour F11 */
        iframe[height="1000"] {
            position: fixed !important;
            top: 8vh !important;       /* Commence SOUS le titre */
            left: 0 !important;
            width: 100vw !important;   /* Prend toute la largeur */
            height: 92vh !important;   /* Prend le reste de la hauteur */
    ...
    # CSS INTERNE IFRAME (Ligne rouge de debug)
