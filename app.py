...
# =========================================================
    ...
    if mode == "attente":
        ...
        <html><body style="background:black;margin:0;height:100vh;display:flex;flex-direction:column;justify-content:center;align-items:center;overflow:hidden;">
            ...
            <h2 style="color:#E2001A;font-family:Arial;font-size:40px;margin-top:10px;">{titre}</h2>
        </body></html>
        """
    ...
    # --- 2. VOTE OFF (CENTRÉ) ---
        ...
        <html><body style="background:black;margin:0;height:100vh;display:flex;flex-direction:column;justify-content:center;align-items:center;overflow:hidden;">
            <div style="border:5px solid #E2001A; padding:50px; border-radius:30px; text-align:center;">
                ...
                <h2 style="color:white;font-family:Arial;font-size:30px;margin-top:20px;">{titre}</h2>
            </div>
        </body></html>
        """
        st.markdown(html, unsafe_allow_html=True)
    ...
    # --- 3. VOTE ON (QR CODE) ---
        ...
        html = f"""
        <html><body style="background:black;margin:0;height:100vh;display:flex;justify-content:center;align-items:center;font-family:Arial;overflow:hidden;">
            <div style="text-align:center;">
                ...
                <div style="color:white;font-size:25px;margin-top:10px;">{titre}</div>
            </div>
    ...
    # --- 4. PODIUM (SÉQUENTIEL & CENTRÉ) ---
        ...
        # Pour le JS, on utilise components.html mais avec un style strict
        components.html(f"""
        <html><head><style>
            ...
            .grid {{ display:flex; justify-content:center; align-items:flex-end; gap:20px; flex-wrap:wrap; }}
            ...
            <script>
                ...
                setInterval(() => {{
                    ...
                    if(el < 5) {{ showIntro=true; txt="LES 3èmes..."; time=5-el; }}
                        ...
                        intro.style.display='none'; final.style.display='flex';
                        // JUSTE LE 1ER TOUT SEUL (CONSECRACTION)
    ...
    # --- 5. PHOTOS LIVE (ANIMATION) ---
        ...
        # Correction JS : Utilisation de concaténation simple au lieu de f-string complexe
